...
public class D路径查找 {
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(D路径查找.class.getClassLoader().getResourceAsStream("file_temp/traffice_project.txt")));
